<template>
  <at-card :no-hover="true" :bordered="false">
    <img v-if="companyLogo" :src="companyLogo" style="width: 100%; height: auto;"/>
...
import {getCompanyLogo} from "../../common/helpers";
...
export default {
  ...
  mounted() {
    this.companyLogo = getCompanyLogo(this.company.logoUrl)
  }
}
</script>
